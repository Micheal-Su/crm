                            ...
                            <div class="col-sm-10" style="width: 300px;">
                                <select class="form-control" id="edit-owner">
                                    ...
                                    <c:forEach items="${activityUserList}" var="u">
                                        <option value="${u.id}" ${a.owner eq u.name ? "selected" : ""}>${u.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
...
<%--            a必须是请求转发而来的  --%>
	...
	<div style="position: relative; top: -70px;">
		<div style="position: relative; left: 40px; height: 30px;">
            ...
            <div style="width: 300px;position: relative; left: 200px; top: -40px;"><b>${a.owner}</b></div>
			<div style="width: 300px;position: absolute; left: 650px; top: 0px;"><b>${a.name}</b></div>
		</div>
		...
		<div style="position: relative; left: 40px; height: 30px; top: 10px;">
            ...
            <div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; bottom: -1px;"></div>
            <div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; left: 450px"></div>
            <div style="width: 300px;position: relative; left: 450px; top: -20px; color: gray;">结束日期</div>
			<div style="width: 300px;position: relative; left: 200px; top: -40px;"><b>${a.startDate}</b></div>
			<div style="width: 300px;position: absolute; left: 650px; top: 0px;"><b>${a.endDate}</b></div>
		</div>
