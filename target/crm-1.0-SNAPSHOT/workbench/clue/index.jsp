			...
			$.ajax({
				...
				success:function (data){
					...
					$.each(data.dataList,function (i,n){
						...
						html += '<td style="background-color: #5e5e5e"><a style="color: aquamarine ;text-decoration: none; cursor: pointer;" onclick="window.location.href=\'workbench/clue/detail.do?id='+n.id+'\';">'+n.fullname+'</a></td>';
						html += '<td style="background-color: #5e5e5e;color: whitesmoke">'+n.company+'</td>';
						html += '<td style="background-color: #5e5e5e;color: whitesmoke">'+n.phone+'</td>';
						html += '<td style="background-color: #5e5e5e;color: whitesmoke">'+n.mphone+'</td>';
						...
						html += '<td style="background-color: #5e5e5e;color: whitesmoke">'+n.state+'</td>';
						html += '</tr>';
	...
	<div class="modal-dialog" role="document" style="width: 90%;">
		<div style="background-color: rgba(41, 45, 62, .8);" class="modal-content">
			<div class="modal-header">
				...
				<h4 style="color: aqua" class="modal-title" id="myModalLabel">创建线索</h4>
			</div>
			<div class="modal-body">
				<form class="form-horizontal" role="form" id="ClueAddForm">

					<div class="form-group">
						<label style="color: aqua" for="create-clueOwner" class="col-sm-2 control-label">所有者<span style="font-size: 15px; color: red;">*</span></label>
						<div class="col-sm-10" style="width: 300px;">
							<select class="form-control" id="create-owner">

							</select>
						</div>
						<label style="color: aqua" for="create-company" class="col-sm-2 control-label">公司<span style="font-size: 15px; color: red;">*</span></label>
						<div class="col-sm-10" style="width: 300px;">
					...
					<div class="form-group">
						<label style="color: aqua" for="create-call" class="col-sm-2 control-label">称呼</label>
						<div class="col-sm-10" style="width: 300px;">
						...
						<label style="color: aqua" for="create-surname" class="col-sm-2 control-label">姓名<span style="font-size: 15px; color: red;">*</span></label>
						<div class="col-sm-10" style="width: 300px;">
					...
					<div class="form-group">
						<label style="color: aqua" for="create-job" class="col-sm-2 control-label">职位</label>
						<div class="col-sm-10" style="width: 300px;">
							<input type="text" class="form-control" id="create-job">
						</div>
						<label style="color: aqua" for="create-email" class="col-sm-2 control-label">邮箱</label>
						<div class="col-sm-10" style="width: 300px;">
					...
					<div class="form-group">
						<label style="color: aqua" for="create-phone" class="col-sm-2 control-label">公司座机</label>
						<div class="col-sm-10" style="width: 300px;">
							<input type="text" class="form-control" id="create-phone">
						</div>
						<label style="color: aqua" for="create-website" class="col-sm-2 control-label">公司网站</label>
						<div class="col-sm-10" style="width: 300px;">
					...
					<div class="form-group">
						<label style="color: aqua" for="create-mphone" class="col-sm-2 control-label">手机</label>
						<div class="col-sm-10" style="width: 300px;">
							<input type="text" class="form-control" id="create-mphone">
						</div>
						<label style="color: aqua" for="create-status" class="col-sm-2 control-label">线索状态</label>
						<div class="col-sm-10" style="width: 300px;">
							<select class="form-control" id="create-state">
								<option style="background-color: #333333;color:aquamarine"></option>
								<c:forEach items="${clueStateList}" var="cs">
									<option style="background-color: #333333;color:aquamarine" value="${cs.value}">${cs.text}</option>
								</c:forEach>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						<label style="color: aqua" for="create-source" class="col-sm-2 control-label">线索来源</label>
						<div class="col-sm-10" style="width: 300px;">
					...
					<div class="form-group">
						<label style="color: aqua" for="create-describe" class="col-sm-2 control-label">线索描述</label>
					...
					<div style="position: relative;top: 15px;">
						<div class="form-group">
							<label style="color: aqua" for="create-contactSummary" class="col-sm-2 control-label">联系纪要</label>
							<div class="col-sm-10" style="width: 81%;">
					...
					<div style="position: relative;top: 20px;">
						<div class="form-group">
							<label style="color: aqua" for="create-address" class="col-sm-2 control-label">详细地址</label>
							<div class="col-sm-10" style="width: 81%;">
	...
	<div class="modal-dialog" role="document" style="width: 90%;">
		<div style="background-color: rgba(41, 45, 62, .8);" class="modal-content">
			<div class="modal-header">
				...
				<h4 style="color: aqua" class="modal-title">修改线索</h4>
			</div>
			<div class="modal-body">
				...
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						<label style="color: aqua" for="edit-clueOwner" class="col-sm-2 control-label">所有者<span style="font-size: 15px; color: red;">*</span></label>
						<div class="col-sm-10" style="width: 300px;">
						...
						<label style="color: aqua" for="edit-company" class="col-sm-2 control-label">公司<span style="font-size: 15px; color: red;">*</span></label>
						<div class="col-sm-10" style="width: 300px;">
					...
					<div class="form-group">
						<label style="color: aqua" for="edit-call" class="col-sm-2 control-label">称呼</label>
						<div class="col-sm-10" style="width: 300px;">
						...
						<label style="color: aqua" for="edit-surname" class="col-sm-2 control-label">姓名<span style="font-size: 15px; color: red;">*</span></label>
						<div class="col-sm-10" style="width: 300px;">
					...
					<div class="form-group">
						<label style="color: aqua" for="edit-job" class="col-sm-2 control-label">职位</label>
						<div class="col-sm-10" style="width: 300px;">
							<input type="text" class="form-control" id="edit-job" value="CTO">
						</div>
						<label style="color: aqua" for="edit-email" class="col-sm-2 control-label">邮箱</label>
						<div class="col-sm-10" style="width: 300px;">
					...
					<div class="form-group">
						<label style="color: aqua" for="edit-phone" class="col-sm-2 control-label">公司座机</label>
						<div class="col-sm-10" style="width: 300px;">
							<input type="text" class="form-control" id="edit-phone" >
						</div>
						<label style="color: aqua" for="edit-website" class="col-sm-2 control-label">公司网站</label>
						<div class="col-sm-10" style="width: 300px;">
					...
					<div class="form-group">
						<label style="color: aqua" for="edit-mphone" class="col-sm-2 control-label">手机</label>
						<div class="col-sm-10" style="width: 300px;">
							<input type="text" class="form-control" id="edit-mphone" >
						</div>
						<label style="color: aqua" for="edit-status" class="col-sm-2 control-label">线索状态</label>
						<div class="col-sm-10" style="width: 300px;">
							<select class="form-control" id="edit-state">
								<option style="background-color: #333333;color:aquamarine"></option>
								<c:forEach items="${clueStateList}" var="s">
									<option style="background-color: #333333;color:aquamarine" value="${s.value}" ${c.state eq s.value ? "selected" : ""}>${s.text}</option>
								</c:forEach>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						<label style="color: aqua" for="edit-source" class="col-sm-2 control-label">线索来源</label>
						<div class="col-sm-10" style="width: 300px;">
					...
					<div style="position: relative;top: 15px;">
						<div class="form-group">
							<label style="color: aqua" for="edit-contactSummary" class="col-sm-2 control-label">联系纪要</label>
							<div class="col-sm-10" style="width: 81%;">
					...
					<div style="position: relative;top: 20px;">
						<div class="form-group">
							<label style="color: aqua" for="edit-address" class="col-sm-2 control-label">详细地址</label>
							<div class="col-sm-10" style="width: 81%;">
	...
	<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
		...
		<div class="btn-toolbar" role="toolbar" style="height: 80px;">
			<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				...
				<div class="form-group">
					<div class="input-group">
						<div style="color: whitesmoke;background-color: #222222" class="input-group-addon">公司</div>
						<input style="color: whitesmoke;background-color: #222222" class="form-control" type="text" id="search-company">
					</div>
				</div>
				...
				<div class="form-group">
					<div class="input-group">
						<div style="color: whitesmoke;background-color: #222222" class="input-group-addon">线索来源</div>
				...
				<div class="form-group">
					<div class="input-group">
						<div style="color: whitesmoke;background-color: #222222" class="input-group-addon">手机</div>
						<input style="color: whitesmoke;background-color: #222222" class="form-control" type="text" id="search-mphone">
					</div>
				</div>

				<div class="form-group">
					<div class="input-group">
						<div style="color: whitesmoke;background-color: #222222" class="input-group-addon">线索状态</div>
						<select style="color: whitesmoke;background-color: #222222" class="form-control" id="search-state">
							<option></option>
							<c:forEach items="${clueStateList}" var="cs">
		...
		<div class="btn-toolbar" role="toolbar" style="background-color: #222222; height: 50px; position: relative;top: 40px;">
		...
		<div style="position: relative;top: 50px;">
			<table class="table table-hover">
				...
				<tbody style="background-color: #222222"  id="clueBody">
		...
		<div style="height: 50px; position: relative;top: 30px;">
			<div style="background-color: #222222;color: whitesmoke;" id="cluePage"></div>
